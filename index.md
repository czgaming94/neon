...
[Sliders](https://github.com/czgaming94/neon/blob/main/docs/Slider.md): Sliders are most often used for setting volumes, but they can be used for many things, including scaling and color changes.
---
---
